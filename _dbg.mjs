...
await p.evaluate(()=>{window.__BANDDBG=true; const g=window.__game;g.hitStopFrames=999999;g.levelIntroFramesRemaining=0;const cx=66*32-430;g.camera.x=cx;g.camera.targetX=cx;});
await p.waitForTimeout(160);
await p.screenshot({path:'/tmp/jg/dbg_band.png'});
console.log('done');
await b.close();
