...
import {
  ...
  Kangaroo, Deer, BrownDeer, DeerBoss, Sheep, Turtle, Mouse, SnakeBoss, Rat, TrashCan, Geyser, RatBoss, Snake, Fireball, Ghost, Fish, Wizard, BombOmb, SpikeBall,
  ...
  for (const spawn of engine.level.entities) {
    ...
    switch (spawn.type) {
      ...
      case EntityType.DEER:
        ...
        break;
      case EntityType.DEER_BROWN:
        engine.entities.push(new BrownDeer(spawn.x, spawn.y));
        break;
      case EntityType.DEER_BOSS:
        engine.entities.push(new DeerBoss(spawn.x, spawn.y));
        break;
      case EntityType.SHEEP:
        engine.entities.push(new Sheep(spawn.x, spawn.y));
        break;
      case EntityType.TURTLE:
        engine.entities.push(new Turtle(spawn.x, spawn.y));
        break;
      case EntityType.MOUSE:
        engine.entities.push(new Mouse(spawn.x, spawn.y));
        break;
      case EntityType.SNAKE_BOSS:
        engine.entities.push(new SnakeBoss(spawn.x, spawn.y));
        break;
      case EntityType.RAT:
        engine.entities.push(new Rat(spawn.x, spawn.y));
        break;
      case EntityType.TRASH_CAN:
        engine.entities.push(new TrashCan(spawn.x, spawn.y));
        break;
      case EntityType.GEYSER:
        engine.entities.push(new Geyser(spawn.x, spawn.y));
        break;
      case EntityType.RAT_BOSS:
        engine.entities.push(new RatBoss(spawn.x, spawn.y));
        break;
